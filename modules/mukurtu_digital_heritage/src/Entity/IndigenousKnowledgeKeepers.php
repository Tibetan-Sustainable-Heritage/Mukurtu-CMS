...
class IndigenousKnowledgeKeepers extends Paragraph implements IndigenousKnowledgeKeepersInterface
{
  public static function bundleFieldDefinitions(EntityTypeInterface $entity_type, $bundle, array $base_field_definitions)
  {
    ...
    $definitions['field_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The Knowledge Keeper\'s name(s), according to their personal or community preferences. This may include their appropriate title or status. Maximum 255 characters.'))
      ->setSettings([
        'max_length' => 255,
      ])
      ->setDefaultValue('')
    ...
    $definitions['field_nation'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('Including the Knowledge Keeper\'s Nation or community foregrounds the importance of relationships when it comes to Indigenous knowledges and recognizes which nations hold which teachings. The  nation/community  element  of  the  citation  not  only  recognizes  the  important  relationship of an Elder or Knowledge Keeper to their nation or community, it helps celebrate the nuances between different community teachings. Maximum 255 characters.'))
      ->setSettings([
        'max_length' => 255,
      ])
      ->setCardinality(1)
    ...
    $definitions['field_living_place'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('Knowledge Keepers may live in places that differ from the origins of their knowledge, nation, or birthplace, and, in some cases, this may be an important relationship they want to recognize. Only used if applicable and indicated by the Knowledge Keeper. Maximum 255 characters.'))
      ->setSettings([
        'max_length' => 255,
      ])
      ->setCardinality(1)
    ...
    $definitions['field_teaching'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('Information such as the familial provenance of the teaching could be included here. For example, the citation might read: “Story about the sisters of the river as told to [Name of story keeper] by their grandmother [or the grandmother’s name].” This element should be discussed with the Knowledge Keeper, to properly describe or classify the knowledge they are sharing. Maximum 255 characters.'))
      ->setSettings([
        'max_length' => 255,
      ])
      ->setCardinality(1)
