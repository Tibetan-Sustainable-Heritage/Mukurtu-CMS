...
class SampleSentence extends Paragraph implements SampleSentenceInterface {
  ...
  public static function bundleFieldDefinitions(EntityTypeInterface $entity_type, $bundle, array $base_field_definitions) {
    ...
    $definitions['field_sentence_recording'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('Audio recording of the sample sentence. Recordings can be assigned a different cultural protocol from the dictionary word to allow differential access to the recordings and metadata. Select "Add media" to select or upload an audio file. Supported file formats: MP3, M4A, WAV, AAC, OGG. Note that the audio file itself includes a contributor field that can be used to record and indicate the name of the speaker.'))
      ->setSettings([
        'target_type' => 'media',
